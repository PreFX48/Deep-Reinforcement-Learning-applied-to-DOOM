...
if __name__ == '__main__':
    ...
    test_environment(weights=args.weights, scenario=args.scenario, window=args.window, total_episodes=args.total_episodes,
                     frame_skip=args.frame_skip, stack_size=args.stack_size)
